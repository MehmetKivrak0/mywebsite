...
const learningResources: LearningResource[] = [
  { name: 'Udemy', iconName: 'simple-icons:udemy' },
  { name: 'YouTube', iconName: 'mdi:youtube' },
  { name: 'freeCodeCamp', iconName: 'simple-icons:freecodecamp' },
  { name: 'Frontend Mentor', iconName: 'simple-icons:frontendmentor' },
  { name: 'Roadmap.sh', iconName: 'simple-icons:roadmapdotsh' },
]

export default function LearningResourcesCarousel() {
  return (
