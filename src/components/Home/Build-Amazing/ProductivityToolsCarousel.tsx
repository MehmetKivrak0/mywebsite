...
const productivityTools: ProductivityTool[] = [
  { name: 'GitHub', iconName: 'mdi:github' },
  { name: 'Jira', iconName: 'logos:jira' },
  { name: 'Linear', iconName: 'simple-icons:linear' },
  { name: 'Slack', iconName: 'logos:slack-icon' },
  { name: 'Discord', iconName: 'ic:baseline-discord' },
]

export default function ProductivityToolsCarousel() {
  return (
      ...
      <div className='flex flex-col gap-2 mb-3'>
        <div>
          <h3 className='text-base sm:text-lg font-semibold text-white'>
            Kullandığım üretkenlik araçları
          </h3>
        </div>
      </div>
