                  ...
                  <div className='pt-9 px-8 absolute z-3 top-0'>
                    <p className='text-white sm:text-3xl text-[22px] leading-[2rem] font-normal'>
                      <Trans
                        tr={
                          <>
                            Yıllık plan seçersen{' '}
                            <span className='font-bold'>%35 indirim</span> kazanırsın
                          </>
                        }
                        en={
                          <>
                    ...
                    <p className='text-xl font-normal text-white pt-5'>
                      <Trans
                        tr='Bu hafta 3.569 kişi bize katıldı'
                        en='This week 3,569 people have signed up with us'
                      />
                    </p>
                  </div>
                </div>
              ...
              <div
                ...
                <div className='flex grow flex-col p-6 sm:p-8'>
                  ...
                  <p className='text-SlateBlue dark:text-darktext opacity-75 text-base pt-6 border-b border-solid border-BorderLine dark:border-dark_border pb-5'>
                    <Trans
                      tr='Yeni başlayanlar / freelancer’lar için ideal'
                      en='Best for people who have the startup / freelancing'
                    />
                  </p>
                  <ul className='flex flex-col grow gap-5 pt-6'>
                    <li className='flex items-center gap-5'>
                      ...
                      <span className='text-base text-SlateBlue dark:text-darktext font-normal'>
                        <Trans tr='Aylık hizmet bedeli' en='Monthly service fee' />
                      </span>
                    </li>
                    <li className='flex items-center gap-5'>
                      <svg
                      ...
                      <span className='text-base text-SlateBlue dark:text-darktext font-normal'>
                        <Trans tr='Otomatik tahsilat' en='Direct debits' />
                      </span>
                    </li>
                    <li className='flex items-center gap-5'>
                      <svg
                      ...
                      <span className='text-base text-SlateBlue dark:text-darktext font-normal'>
                        <Trans tr='Online ödemeler' en='Online payments' />
                      </span>
                    </li>
                    <li className='flex items-center gap-5'>
                      <svg
                      ...
                      <span className='text-base text-SlateBlue dark:text-darktext font-normal'>
                        <Trans tr='Para yatırma' en='Deposits to Savers' />
                      </span>
                    </li>
                    <li className='flex items-center gap-5'>
                      <svg
                      ...
                      <span className='text-base text-SlateBlue dark:text-darktext font-normal'>
                        <Trans tr='Uluslararası işlem ücretleri' en='International transaction fees' />
                      </span>
                    </li>
                  </ul>
                  <Link
                    ...
                    <Trans tr='14 gün ücretsiz dene' en='Try free for 14 days' />
                  </Link>
                </div>
              </div>
              <div
                ...
                <div className='flex grow flex-col p-6 sm:p-8'>
                  <span className='text-[22px] leading-[2rem] font-bold text-SlateBlue dark:text-darktext pb-3'>
                    <Trans tr='Profesyonel' en='Professional' />
                  </span>
                  <div>
                    <span className='text-5xl font-bold text-secondary dark:text-white'>
                  ...
                  <p className='text-SlateBlue dark:text-darktext opacity-75 text-base pt-6 border-b border-solid border-BorderLine dark:border-dark_border pb-5'>
                    <Trans
                      tr='Daha fazla özellik isteyen profesyoneller için'
                      en='Best for professionals who need more features'
                    />
                  </p>
                  <ul className='flex flex-col grow gap-5 pt-6'>
                    <li className='flex items-center gap-5'>
