    ...
    return (
        <>
            ...
            <div className="p-6 rounded-md border mt-4 border-BorderLine dark:border-dark_border border-solid">
                <p className="text-base font-medium text-SlateBlue dark:text-darktext flex lg:flex-row flex-col" >
                  1. Change Logo over here / Logo değiştirmek için:
                  <span className="font-semibold text-base overflow-x-auto">src/components/Layout/Header/Logo/index.tsx</span>
                </p>
